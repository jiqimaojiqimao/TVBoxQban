...
public class ExoMediaPlayer extends AbstractPlayer implements Player.Listener {
    ...
    public void onPlayerError(@NonNull PlaybackException error) {
       String progressKey = Hawk.get(HawkConfig.EXO_PROGRESS_KEY, "");
        ...
        if (errorCode == 5001 && mRetryCount < MAX_RETRIES || errorCode == 5002 && mRetryCount < MAX_RETRIES || errorCode == 4001 && mRetryCount < MAX_RETRIES || errorCode == 4003 && mRetryCount < MAX_RETRIES || errorCode == 1001 && mRetryCount < MAX_RETRIES){

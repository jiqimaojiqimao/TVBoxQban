...
Picasso.get().load(Url).placeholder(R.drawable.xumusic).centerCrop().into(MxuamengMusic).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE); // xuameng内容空显示banner
}	
MxuamengMusic.setVisibility(GONE);
MxuamengMusic.setVisibility(VISIBLE);

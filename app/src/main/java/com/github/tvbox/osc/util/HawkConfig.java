...
public class HawkConfig {
    ...
    public static final String EXO_VIDEO_SOFT_DECODE = "exo_video_soft_decode"; //xuameng 
    public static final String EXO_AUDIO_SOFT_DECODE = "exo_audio_soft_decode"; //xuameng 

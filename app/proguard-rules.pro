...
# 1. XOM库保留规则
-keep class nu.xom.** { *; }
-keep interface nu.xom.** { *; }

# 2. Jettison库保留规则
-keep class org.codehaus.jettison.** { *; }
-keep interface org.codehaus.jettison.** { *; }
...
# 进阶优化配置
# 按需保留XML驱动类
-keep class com.thoughtworks.xstream.io.xml.XomDriver { *; }
-keep class com.thoughtworks.xstream.io.xml.Dom4JDriver { *; }
-keep class com.thoughtworks.xstream.io.xml.JDomDriver { *; }
# 资源文件保留
-keep class **.xml { *; }
-keep class **.xsd { *; }
# 显式声明缺失的类
